...
import cleaverAxeHeadIconUrl from "$lib/assets/machine-modules/cleaver-axe-head.png";
...
import parryReflectorIconUrl from "$lib/assets/machine-modules/parry-reflector.png";
