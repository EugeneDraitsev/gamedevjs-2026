...
>
    ...
    <T.Mesh position={[-0.28, 0.6, 0.82]} rotation={[0.42, -0.18, -0.75]} scale={[0.018, 0.34, 0.018]}>
        <T.BoxGeometry args={[1, 1, 1]}/>
        <T.MeshStandardMaterial color="#16100b" roughness={0.8}/>
    </T.Mesh>

    <T.Mesh position={[-0.15, 0.43, 0.93]} rotation={[0.18, 0.1, 0.35]} scale={[0.014, 0.23, 0.018]}>
        <T.BoxGeometry args={[1, 1, 1]}/>
        <T.MeshStandardMaterial color="#15100b" roughness={0.8}/>
    </T.Mesh>

    <T.Mesh position={[0.34, -0.18, 0.88]} rotation={[-0.25, 0.16, -0.5]} scale={[0.014, 0.29, 0.018]}>
        <T.BoxGeometry args={[1, 1, 1]}/>
